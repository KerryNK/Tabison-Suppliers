    ...
    >
      ...
      {product.tags && product.tags.includes("New") && (
        <Chip
          ...
          color="primary"
          size="small"
          sx={{ position: "absolute", top: 12, left: 12, zIndex: 2, fontWeight: 700 }}
        />
      )}
      {product.tags && product.tags.includes("Best Seller") && (
        <Chip
          ...
          color="secondary"
          size="small"
          sx={{ position: "absolute", top: 12, right: 48, zIndex: 2, fontWeight: 700 }}
        />
      )}
      {product.images && product.images[0] ? (
        <CardMedia
          ...
          alt={product.name}
          sx={{ height: 180, objectFit: "cover", bgcolor: "#f9f9f9" }}
        />
      ) : (
      ...
      <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
        <Typography
          variant="h6"
          sx={{ fontWeight: 700, mb: 1, color: "primary.main", textAlign: "center", width: "100%" }}
        >
          {product.name}
        </Typography>
        ...
        <Typography variant="body1" sx={{ color: "secondary.main", mb: 2, fontWeight: 600 }}>
        ...
        <motion.div animate={cartAnim} style={{ width: "100%" }}>
          <Button
            variant="contained"
            color="secondary"
            sx={{ mt: "auto", fontWeight: 700, width: "100%" }}
