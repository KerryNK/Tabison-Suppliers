  ...
  const handleNext = async () => {
    ...
    switch (activeStep) {
      ...
      case 1:
        ...
        break
      case 2:
        fieldsToValidate = ["address", "city", "county"]
        break
    }
        ...
        <Card>
          <CardContent sx={{ textAlign: "center", py: 4 }}>
            ...
            <Typography variant="body1" sx={{ mb: 3 }}>
              Thank you for registering with Tabison Suppliers. Your application has been submitted and is currently
              under review. We'll notify you via email once your account is approved.
            </Typography>
            <Button variant="contained" onClick={() => navigate("/suppliers")} sx={{ mt: 2 }}>
              Browse Suppliers
            </Button>
          </CardContent>
        </Card>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                type="number"
                {...register("yearEstablished", { setValueAs: (v) => (v === "" ? "" : Number.parseInt(v, 10)) })}
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.description?.message || "Provide a detailed description of your company and services."
                }
                required
              />
            </Grid>
                  ...
                  <Box>
                    {Object.entries(field.value).map(([day, value]) => (
                      <BusinessHoursInput
                        ...
                        value={value as any}
                        onChange={(dayName, newValues) => field.onChange({ ...field.value, [dayName]: newValues })}
                      />
                    ))}
                  </Box>
                )}
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                ...
                <Typography>
                  <strong>Company:</strong> {values.name}
                </Typography>
                <Typography>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                ...
                <Typography>
                  <strong>Type:</strong> {values.businessType}
                </Typography>
                {values.yearEstablished && (
                  <Typography>
                    <strong>Established:</strong> {values.yearEstablished}
                  </Typography>
                )}
                <Typography>
                  <strong>Specialties:</strong> {values.specialties.join(", ")}
                </Typography>
                <Typography>
            ...
            <Grid item xs={12}>
              <Paper sx={{ p: 3 }}>
                ...
                <Typography>
                  <strong>City:</strong> {values.city}, {values.county}
                </Typography>
                <Typography>
                  <strong>Contact Person:</strong> {values.contactPerson.name}
                </Typography>
                <Typography>
                  <strong>Contact Email:</strong> {values.contactPerson.email}
                </Typography>
              </Paper>
            </Grid>
          </Grid>
